...
def homepage(request):
    ...
    if request.method=='POST':
        ...
        try:
            ...
            return render(request, 'homepage.html',{'all_classes':all_classes,'user_obj':user_obj,'message':message})
           
             
    return render(request, 'homepage.html',{'all_classes':all_classes,'user_obj':user_obj})
...
def single_class(request,id):
    ...
    return render(request, 'single_class.html',{'single_class':single_class, 'teachers':teachers ,'user_obj':user_obj})
...
def register(request,class_name):
    ...
    if request.method == 'POST':
        ...
        if email=='' or password1=='' or name=='' or password2=='':
            ...
            return render(request, 'register.html',{'user_obj':user_obj,'error':error,'class_name':class_name})
        ...
        if user_obj==None:
            try:
                ...
                try:
                    ...
                    return render(request, 'register.html',{'user_obj':student_obj,'error':error,'class_name':class_name})
                except:
    ...
    return render(request, 'register.html',{'user_obj':user_obj,'class_name':class_name})
